> 🔗 Связанные: [[Unknown Words]] · [[Vocabulary Glossary]] · [[Setup]]
...
const DECKS = [
  ...
  { id: 'egw',          name: 'EG — All Words',              file: 'word-tracker.csv', label: 'All Words', fields: ['word','ipa','translation','filename','exportedAt','status','knownAt','s1','s2','s3','note'], frontKey: 'word', backKey: 'translation', tagPrefix: 'egw' },
