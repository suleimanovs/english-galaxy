...
## Важное вступление для русскоязычных
...
Present Simple — это время для описания того, что **всегда так**, **обычно так** или **регулярно происходит**. Оно не описывает то, что происходит прямо сейчас в эту секунду. Это время про постоянство, привычки, факты, законы природы и расписания.

Представь себе фотографию жизни человека в целом — не в конкретный момент, а вообще. Вот как он живёт, что делает, во что верит, где работает. Это и есть Present Simple.
...
### Как добавляется окончание -s / -es для he / she / it

Это одно из самых частых мест для ошибок. Правила добавления окончания:
...
**Окончание -es, если глагол заканчивается на: -s, -ss, -sh, -ch, -x, -o:**
- go → goes
- do → does
- watch → watches
- wash → washes
...
**Если глагол заканчивается на согласную + -y, то -y меняется на -ies:**
- study → studies
- try → tries
- fly → flies
- carry → carries

**Если перед -y стоит гласная, то просто -s:**
- play → plays
- say → says
- buy → buys
- enjoy → enjoys
...
Обрати внимание: когда есть **does**, основной глагол остаётся в начальной форме — без -s.

**Примеры:**

- I don't like coffee. — Мне не нравится кофе.
- You don't understand. — Ты не понимаешь.
- We don't work on Sundays. — Мы не работаем по воскресеньям.
...
```
Wh-word + do/does + subject + глагол?
```

- Where do you live? — Где ты живёшь?
- What does she do? — Чем она занимается? (Кем она работает?)
- How often do they meet? — Как часто они встречаются?
- Why does he come late? — Почему он приходит поздно?
- What time does the train leave? — В какое время отходит поезд?
...
- She goes to the gym three times a week. — Она ходит в зал три раза в неделю.
- We always have dinner together. — Мы всегда ужинаем вместе.
...
- Water boils at 100 degrees Celsius. — Вода кипит при 100 градусах.
...
- The train leaves at 8:15. — Поезд отходит в 8:15.
...
| in the morning / evening | по утрам / вечерам |
| generally | в целом, как правило |
| normally | обычно, как правило |
| twice a week / month | два раза в неделю / месяц |
...
- We are waiting for you. — Мы ждём тебя.
...
- They aren't working today. — Они сегодня не работают.
- He isn't paying attention. — Он не обращает внимания.
...
- Am I bothering you? — Я мешаю тебе?
...
| today | сегодня (в значении «в этот период») |
...
# 3. Present Perfect — Настоящее совершённое время
...
- They have arrived. / They've arrived. — Они приехали.
- He has broken his leg. — Он сломал ногу.
...
- We haven't met before. — Мы раньше не встречались.
- He hasn't finished the project. — Он не закончил проект.
...
- How many times has she visited London? — Сколько раз она была в Лондоне?
...
**yet** (уже / ещё) — в вопросах и отрицаниях, означает «к настоящему моменту»:
...
- They haven't called this month. — В этом месяце они не звонили. (месяц ещё идёт)
...
| just | только что | утверждения |
| ever | когда-либо | вопросы |
| never | никогда | отрицания |
| for | в течение (период) | с длительностью |
...
# 4. Present Perfect Continuous — Настоящее совершённое продолженное время
...
- He hasn't been answering my calls. — Он не отвечает на мои звонки.
...
- We've been spending a lot of money this month. — В этом месяце мы много тратим.
...
| Слово / фраза | Перевод |
|---|---|
| for + период | в течение (for two hours, for years) |
| since + момент | с (since Monday, since 2019) |
| all day / all week / all morning | весь день / всю неделю / всё утро |
| lately / recently | в последнее время / недавно |
| how long? | как долго? |
